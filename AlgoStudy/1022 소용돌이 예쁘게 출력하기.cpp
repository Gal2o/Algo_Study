...
//
//    // 양 끝점이 0이 아니면 다채워짐
//    // 처음에 이동을 for문으로 dcnt만큼 한번에 이동했는데,
...
//     * 0 7 8 9 10
//     * 0 0 0 0 0
//     * 3x3 배열 크기를 [r2-r1][c2-c1] 이라 하면,
//     * dcnt는 오른쪽으로 갈 때 1 증가하여 7에서 10까지 3칸 가므로,
//     * 9에서 탈출을 시켜줘야 자릿수 출력 때, 공백이 0칸
